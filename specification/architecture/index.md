...
<code>objpath ::= name '.' ( name ( '.' inst | reffollow '.' name)? '.' )*</code>
...
<code>cmdpath ::= objpath name '()'</code>
...
<code>evntpath ::= objpath name '!'</code>
...
<code>expr ::= '[' exprcomp ( '&&' exprcomp )* ']'</code>
...
<code>exprcomp ::= relpath oper value</code>
...
<code>relpath ::= name ( reffollow? '.' name )*</code>
...
<code>name ::= [A-Za-z_] [A-Za-z_0-9]*</code>
...
<code>sdmpath ::= name '.' ( name '.' ( ( posnum | '{i}' ) '.' )? )* name?</code>
